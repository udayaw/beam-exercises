...
public class StreamingMinuteTrafficPipeline {
    ...
    public static PipelineResult run(Options options) {
        ...
        /*
                ...
                BigQueryIO.Write will default to either streaming inserts
                 (https://cloud.google.com/bigquery/streaming-data-into-bigquery)
                 for unbounded PCollections or batch file load jobs for bounded PCollections. Streaming inserts can be particularly useful when you want data to show up in aggregations immediately, but does incur extra charges.
                ...
                Refer to the https://beam.apache.org/releases/javadoc/2.22.0/org/apache/beam/sdk/io/gcp/bigquery/BigQueryIO.Write.Method.html to learn more.
         */
